...
// File @clober/library/contracts/PackedUint256.sol@v1.0.0
...
// File @clober/library/contracts/SignificantBit.sol@v1.0.0
...
// File @clober/library/contracts/OctopusHeap.sol@v1.0.0
...
// File @clober/library/contracts/DirtyUint64.sol@v1.0.0
...
// File @clober/library/contracts/SegmentedSegmentTree.sol@v1.0.0
...
// File contracts/interfaces/CloberOrderKey.sol
...
// File contracts/interfaces/CloberOrderBook.sol
...
// File contracts/interfaces/CloberOrderNFT.sol
...
// File contracts/interfaces/CloberMarketDeployer.sol
...
// File contracts/interfaces/CloberVolatileMarketDeployer.sol
...
// File contracts/markets/GeometricPriceBook.sol
...
abstract contract GeometricPriceBook {
    ...
    function _priceToIndex(
        uint128 price,
        bool roundingUp
    ) internal view virtual returns (uint16 index, uint128 correctedPrice) {
...
// File contracts/interfaces/CloberMarketFactory.sol
...
// File contracts/interfaces/CloberMarketFlashCallbackReceiver.sol
...
// File contracts/interfaces/CloberMarketSwapCallbackReceiver.sol
...
// File contracts/utils/OrderKeyUtils.sol
...
// File contracts/utils/RevertOnDelegateCall.sol
...
abstract contract OrderBook is CloberOrderBook, ReentrancyGuard, RevertOnDelegateCall {
    ...
    function _calculateClaimableAmountAndFees(
        ...
        uint16 priceIndex
    ) internal view returns (uint256 claimableAmount, int256 makerFeeAmount, uint256 takerFeeAmount) {
    ...
    function _expectTake(
        ...
        uint16 currentIndex,
        bool expendInput
    ) internal view returns (uint256, uint256, uint64) {
    ...
    function _claim(
        ...
        OrderKey memory orderKey,
        address claimer
    ) private returns (uint256 transferAmount, uint256 minusFee, uint64 claimedRawAmount) {
        uint256 claimBounty;
...
// File contracts/markets/VolatileMarket.sol
...
// File contracts/markets/VolatileMarketDeployer.sol
